...
def test(data,
    ...
    for batch_i, (img, targets, paths, shapes) in enumerate(tqdm(dataloader, desc=s)):
        ...
        with torch.no_grad():
            ...
            # t1_buffer = time_synchronized() - t

            # t = tuple(x / seen * 1E3 for x in (t0, t1, t0 + t1)) + (imgsz, imgsz, batch_size)  # tuple
            # if not training:
            # print('Speed: %.1f/%.1f/%.1f ms inference/NMS/total' % tuple([t0_buffer * 1E3, t1_buffer * 1E3, (t0_buffer+t1_buffer)*1E3]))
    ...
    if save_json and len(jdict):
        ...
        try:  # https://github.com/cocodataset/cocoapi/blob/master/PythonAPI/pycocoEvalDemo.ipynb
            ...
            cocoGt = COCO(glob.glob("/home/ntu329/Documents/Datasets/other_datasets/coco/annotations/instances_val2017.json")[0])
